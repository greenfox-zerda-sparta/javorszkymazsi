...
bool Analitics::analyse_all(std::vector<std::vector<int>>& board) {
...
bool Analitics::analyse_diagonally_from_left(std::vector<std::vector<int>>& board) {
...
bool Analitics::analyse_diagonally_from_right(std::vector<std::vector<int>>& board) {
  for (unsigned int i = 0; i < board.size(); ++i) {
...
bool Analitics::analyse_horizontally(std::vector<std::vector<int>>& board) {
  for (unsigned int i = 0; i < board.size(); ++i) {
    for (unsigned int j = 0; j < board[i].size(); ++j) {
      if (board[i][j] == 1 || board[i][j] == 2) {
...
bool Analitics::analyse_vertically(std::vector<std::vector<int>>& board) {
  for (unsigned int i = 0; i < board.size(); ++i) {
    for (unsigned int j = 0; j < board[i].size(); ++j) {
      if (board[i][j] == 1 || board[i][j] == 2) {
